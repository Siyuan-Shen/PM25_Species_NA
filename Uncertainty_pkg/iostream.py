...
def load_pixels_nearest_sites_distances_map():
    indir = '/my-projects/PM25_Speices_DL_2023/data/Pixels2sites_distances/'
    infile = indir + '{}_nearest_site_distances_forEachPixel.npy'.format(species)
    distances_map = np.load(infile)
    return distances_map

def load_BLOO_rRMSE():
    indir = '/myprojects/Projects/PM25_Speices_DL_2023/code/Training_Evaluation_Estimation/{}/{}/Results/results-BLOOCV/'.format(species, version)
...
def load_absolute_uncertainty_map_data(YYYY:str, MM:str, version:str, special_name):
    indir = Estimation_outdir + '{}/{}/Uncertainty_Results/Absolute-Uncertainty_Map/'.format(species,version)
...
def save_absolute_uncertainty_data(final_data:np.array, YYYY:str, MM:str):
    outdir = Estimation_outdir + '{}/{}/Uncertainty_Results/Absolute-Uncertainty_Map/'.format(species,version)
